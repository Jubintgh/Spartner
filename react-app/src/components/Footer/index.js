        ...
        <div className='footer-container'>
          ...
          <div className='footer-content-row-1'>
            ...
            <div className='footer-col-row1'>
              <img alt="AKphoto" className='footer-profilePic' src='https://avatars.githubusercontent.com/u/78562233?v=4'/>
              <h3>Austin Kuemper</h3>
              <div className='footer-row-row2'>
                <a rel="noreferrer" href='https://github.com/AKuemper' target='_blank'>
                  <FaGithub />
                </a>
                <a rel="noreferrer" href='https://angel.co/u/austin-kuemper' target='_blank'>
                  <FaAngellist />
                </a>
                <a rel="noreferrer" href='https://github.com/AKuemper' target='_blank'>
                  <MdWeb />
            ...
            {/* Matt */}
            <div className='footer-col-row1'>
              <img alt="MattPhoto" className='footer-profilePic' src='https://avatars.githubusercontent.com/u/79602970?v=4' />
            ...
            {/* Tony */}
            <div className='footer-col-row1'>
              <img alt="TonyPic" className='footer-profilePic' src='https://avatars.githubusercontent.com/u/35717793?v=4' />
              <h3>Tony Costanza</h3>
              <div className='footer-row-row2'>
