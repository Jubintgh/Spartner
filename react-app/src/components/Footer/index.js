        ...
        <div className='footer-container'>
          ...
          <div className='footer-content-row-1'>
            ...
            <div className='footer-col-row1'>
              ...
              <div className='footer-row-row2'>
                <a href='https://github.com/AKuemper' target='_blank'>
                  <FaGithub />
                </a>
                <a href='https://angel.co/u/austin-kuemper' target='_blank'>
                  <FaAngellist />
                </a>
                <a href='https://github.com/AKuemper' target='_blank'>
                  <MdWeb />
            ...
            <div className='footer-col-row1'>
              ...
              <h3>Jubin Taghdir</h3>
              <div className='footer-row-row2'>
                <a href='https://github.com/Jubintgh' target='_blank'>
                  <FaGithub />
                </a>
                <a href='https://angel.co/u/jubin-taghdir' target='_blank'>
                  <FaAngellist />
                </a>
                <a href='https://github.com/Jubintghr' target='_blank'>
                  <MdWeb />
                </a>
                <a
            ...
            <div className='footer-col-row1'>
              ...
              <h3>Matthew Melendez</h3>
              <div className='footer-row-row2'>
                <a href='https://github.com/melendezmatt' target='_blank'>
                  <FaGithub />
                </a>
                <a href='https://angel.co/u/matthew-melendez-1' target='_blank'>
                  <FaAngellist />
                </a>
                <a href='https://github.com/melendezmatt' target='_blank'>
                  <MdWeb />
            ...
            <div className='footer-col-row1'>
              ...
              <h3>Tony Costanza</h3>
              <div className='footer-row-row2'>
                <a href='https://github.com/AnthonyCost' target='_blank'>
                  <FaGithub />
                </a>
                <a href='https://angel.co/u/anthony-costanza-1' target='_blank'>
                  <FaAngellist />
                </a>
                <a
