...
def seed_users():
    ...
    user41 = User(first_name='Kevin', last_name='Cordova', username='facebookslalom', password='Password1!', gender=1, coach=True, discipline=8, location='Malad City, ID', age=44, img_url='inTheWorks.jpg')
    ...
    user50 = User(first_name='Mohammad', last_name='Pearce', email='audrey_witting@yahoo.com',username='spritehandball', password='Password1!', gender=0, coach=True, discipline=1, location='Orange, MA', age=56, age=31, img_url='inTheWorks.jpg')
